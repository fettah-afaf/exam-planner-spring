                ...
                <div class="col-lg-10 col-12 mx-auto">
                    ...
                    <div class="row pt-lg-5">
                        <div class="col">
                            ...
                            <f:form action="${pageContext.request.contextPath}/admin/elements/editElement" method="POST" modelAttribute="editedElement">
                                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                                <f:hidden path="idElementPedagogique" />
                                <div class="row">
                                    <div class="col">
                                        <label>Name</label>
                                ...
                                <button type="submit" class="btn btn-primary mt-3">Edt Element</button>
                            </f:form>
                        </div>
                    </div>
